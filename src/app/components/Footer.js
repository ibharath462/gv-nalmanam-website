...
import { Phone, Mail, MapPin, Shield, Award, Leaf } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <footer className="bg-white border-t" style={{ borderColor: "#CFE1CB" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-600 text-base leading-relaxed">
              ...
              prepared using traditional home-made process without any
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-600 mb-4 md:mb-0">
              Made with traditional recipes, delivered with modern convenience
            </p>
      ...
      {/* Add keyframes for animations used elsewhere in the site */}
    </footer>
  );
};
